package basex;
//NOTE: The following code is identical to org.basex.examples.api.BaseXClient

//      except for Java modifiers.
...
public class BaseXClient implements Closeable {
	 ...
	 */
	// remove private
	void receive(final InputStream input, final OutputStream output) throws IOException {
